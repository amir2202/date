...
class ImageHandler{
  ...
  static Future<bool> uploadImage(File file, String userid,bool profile) async {
    bool upload = false;
  ...
  """;
    ...
    client.mutate(MutationOptions(documentNode:gql(mutation),variables: {'img':img64,'userid':userid,'pfp':profile}));
